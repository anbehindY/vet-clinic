...
> Vet clinic database is the database created using PosgreSQL.
> It also consist of a list of queries to clarify specific quests.

**Vet clinic database** is just a list of SQL queries that forms the database of vet clinic.
...
Contributions, issues, and feature requests are welcome!
 ...
 - https://github.com/anbehindY/vet-clinic/issues
